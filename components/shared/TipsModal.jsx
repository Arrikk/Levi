...
const TipsModal = ({ feedItem, setFeedItem }) => {
  ...
  return (
    <>
      <input type="checkbox" id={`tip-modal-${feedItem?.id}`} className="modal-toggle" />
      <div className="modal">
        <div className="modal-box">
          ...
          <div className="modal-action">
            <label htmlFor={`tip-modal-${feedItem.id}`} ref={cancelButton} className="btn btn-outline">
              Cancel
            </label>
